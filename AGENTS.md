...
compartido de Plataforma en `../platform`.

Las memorias, prompts y scripts operativos del producto pertenecen al repositorio
backend. No crear documentación pública durante una tarea de código.
